  ...
  return (...args) => {
    ...
    args.forEach((arg) => {
      ...
      if (Array.isArray(arg)) {
        ...
        argsRepresentation.push(`[${arr}]`);
      } else {
        argsRepresentation.push(arg);
      }
    });
    logFunc(`${func.name}(${argsRepresentation}) starts`);
    const res = func(...args);
    logFunc(`${func.name}(${argsRepresentation}) ends`);
    return res;
  };
}
